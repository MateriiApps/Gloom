...
class OrgsListScreen(
    ...
    private fun Screen(
        viewModel: OrgListViewModel = getScreenModel { parametersOf(username) }
    ) {
        val orgs = viewModel.orgs.collectAsLazyPagingItems()
        val scrollBehavior = TopAppBarDefaults.exitUntilCollapsedScrollBehavior()
        val isLoading = orgs.loadState.refresh == LoadState.Loading
    ...
    private fun TopBar(
        ...
        LargeToolbar(
            title = stringResource(R.string.noun_orgs),
            showBackButton = true,
