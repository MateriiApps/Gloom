...
class InstallService: Service() {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        when(val statusCode = intent.getIntExtra(PackageInstaller.EXTRA_STATUS, -999)) {
            ...
            PackageInstaller.STATUS_SUCCESS -> showToast(getString(R.string.install_success))

            PackageInstaller.STATUS_FAILURE_ABORTED -> showToast(getString(R.string.install_cancelled))
